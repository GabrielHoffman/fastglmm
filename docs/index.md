...
[lme4](https://cran.r-project.org/web/packages/lme4/index.html), and
uses familar mixed model syntax and R generics. Since **fastglmm** is
designed for large datasets and GLMMs in mind, it uses maximum
...
- Interface between R and C++ is implemented in
  ...
  and
  [RcppParallel](https://cran.r-project.org/web/packages/RcppParallel/)
- Implemented in C++17
