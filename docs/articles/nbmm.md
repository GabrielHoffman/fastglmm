...
disease status explains 1.33% of observed expression variation,
variation across subjects explains 2.1%, with sex and age making a
smaller contribution. The residual variance explains the remaining 96.5%
and captures both the variance not captured by these variables in the
model and measurement error due to finite counts.
